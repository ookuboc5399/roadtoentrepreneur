...
function ChapterTemplate({ title, backLink, sections }: ChapterTemplateProps) {
  ...
  return (
    <div className="h-screen bg-gradient-to-b from-purple-900 to-purple-950">
      {/* モバイル用ヘッダー */}
      <div className="lg:hidden flex items-center justify-between p-4 border-b border-purple-800/50">
      ...
      {/* デスクトップ用サイドバー */}
      <div className="hidden lg:flex h-full w-64 border-r border-purple-800/50 flex-col">
