...
export function Header_sidebusiness() {
  return (
    <header className="h-16 bg-gradient-to-r from-green-900 to-green-950 border-b border-green-800/50">
      <div className="flex items-center justify-between h-full px-6">
        ...
        <div className="flex items-center space-x-6">
          <nav className="flex space-x-4">
            <Link href="/mypage/account/profile">
              <div className="px-3 py-2 text-sm text-white/70 hover:text-white hover:bg-green-800/50 rounded-lg transition-colors">
                マイページ
              </div>
            </Link>
          </nav>
