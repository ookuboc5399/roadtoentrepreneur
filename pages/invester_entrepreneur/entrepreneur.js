...
import Header_entrepreneur from '../../components/header/header_entrepreneur';
            ...
            <div>
              ...
              <Link href="./startup/startup">
                  <div class="flex items-center justify-center mt-4 py-2 px-6 text-gray-500 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100">
                    ...
                    <span class="mx-3 text-2xl text-white">スタートアップ</span>
                  </div>
                </Link>
                <Link href="./employment/employment">
                  <div class="flex items-center justify-center mt-4 py-2 px-6 text-gray-500 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100">
                    <svg class="h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path stroke-linecap="round" strokeLinejoin="round" stroke-width="2" d="M11 3.055A9.001 9.001 0 1020.945 13H11V3.055z"></path>
                      <path stroke-linecap="round" strokeLinejoin="round" stroke-width="2" d="M20.488 9H15V3.512A9.025 9.025 0 0120.488 9z"></path>
                    </svg>
                    <span class="mx-3 text-2xl text-white">働き方を変える</span>
                  </div>
                </Link>
                <Link href="./experience/experience">
                  <div class="flex items-center justify-center mt-4 py-2 px-6 text-gray-500 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100">
                    ...
                    <span class="mx-3 text-2xl text-white">経験を大事にする</span>
                  </div>
                </Link>
                <Link href="./management/management">
                  <div class="flex items-center justify-center mt-4 py-2 px-6 text-gray-500 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100">
                    ...
                    <span class="mx-3 text-2xl text-white">マネジメント</span>
                  </div>
                </Link>
                <Link href="./analysis/analysis">
                  <div class="flex items-center justify-center mt-4 py-2 px-6 text-gray-500 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100">
                    ...
                    <span class="mx-3 text-2xl text-white">企業分析</span>
                  </div>
                </Link>
                <Link href="./mind/mind">
                  <div class="flex items-center justify-center mt-4 py-2 px-6 text-gray-500 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100">
                    ...
                    <span class="mx-3 text-2xl text-white">マインド</span>
                  </div>
                </Link>
              </nav>
            </div>
