    ...
    return (
        <Mypage>
            <div className='flex flex-between'>
                <div>
                    <h1 className='text-center'>サロン</h1>
                    <div className='flex'>
                        <div class="w-full max-w-sm bg-white rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700 m-2">
                            <Image
                            ...
                            <div class="px-5 pb-5">
                                <a href="#">
                                    <h5 class="text-xl font-semibold tracking-tight text-gray-900 dark:text-white">投資・起業</h5>
                                </a>
                ...
                <div className="ml-6">
                    <div className="bg-white text-center shadow-xl p-8 w-80 rounded">
                        ...
                        <div className="mt-4">
                            ...
                            <p className="text-xs mt-2 text-gray-600">Django</p>
                        </div>
